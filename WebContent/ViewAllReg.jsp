...
<html>
<head>
<title>LIST OF ALL REGISTRATIONS</title>
...
<body>
	<form name="frmreg" method="post" action="loginCheck">
		<ul>
			<li><a class="active" href="ViewAllReg.jsp">All
					Registrations</a></li>
			<li><a href="ViewAllUsers.jsp">All Users</a></li>
		...
		%>
		<h2 align="center">
			<font><strong>LIST OF ALL REGISTRATIONS</strong></font>
		</h2>
